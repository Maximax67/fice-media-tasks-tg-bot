...
export const HELP_MESSAGE =
  ...
  '/limit_access — Обмежити команди бота, які вносять зміни в базу даних, лише для адміністраторів чату.\n' +
  '/open_access — Зняти обмеження з команд бота в чаті.\n' +
  '/export_data — Експорт данних про чат у JSON форматі.\n' +
